var mandelbrot = (function (exports) {
	'use strict';
	...
	var palette_1 = createCommonjsModule(function (module) {
	...
	function mandelbrot_pixels(point, zoom, size) {
	    ...
	    return transfer(pxs, [pxs.buffer]);
	}

	expose({ mandelbrot_pixels });

	exports.mandelbrot_pixels = mandelbrot_pixels;
